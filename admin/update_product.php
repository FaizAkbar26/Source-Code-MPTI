...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" name="stock" required class="box" min="0" max="9999999999" placeholder="Product Stock" onkeypress="if(this.value.length == 0) return false;" value="<?= $fetch_products['stock']; ?>">
      <div class="flex-btn">
